...
function buildMapMenu(MapLabels){
	...
	$(MapLabels).each(function(key, record){
		lBldgs[record.user_properties.bldgName] = record.user_properties.bldgName;
		lButtons[record.properties.mapLabelId] = '<li  id="'+record.properties.mapLabelId+'"  data-id="'+record.properties.mapLabelId+'"  class="list-group-item"  >';
